...
def visualize_TSNE():
    dataset = LMDBDataset("latent_embeddings", desired_class_label=None)
...
def visualize_LLE():
    ...
    # BOTTOM
    embeddings_reduced = LocallyLinearEmbedding(n_components=3, n_neighbors=50).fit_transform(bottom_embeddings)
