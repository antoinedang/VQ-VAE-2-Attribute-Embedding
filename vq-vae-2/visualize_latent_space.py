...
embeddings_reduced = TSNE(n_components=3, perplexity=30, random_state=0).fit_transform(top_embeddings) 
...
# BOTTOM
embeddings_reduced = TSNE(n_components=3, perplexity=30, random_state=0).fit_transform(bottom_embeddings) 
